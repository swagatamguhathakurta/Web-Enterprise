...
<%
	   ...
	   MySqlDataStoreUtilities.updatedetail(bid,Num,name,age,sex);
...
<%
    ...
    try {
            ...
            out.println("<article>");           
            out.println("<center><h2>UPDATE DETAILS</h2></center>");   
            out.println("</article>");
            out.println("<hr>");
            out.println("<h2>Your Product has been updated successfully.</h2>");
